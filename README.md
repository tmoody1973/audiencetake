...
| Durable research runtime, agent pipeline, and Scout Card | Implemented locally; deployed integration validation in progress |
| Native social layer, creator claiming, and submission polish | Planned |
